...
export default function ComprasViews({ ip, idOrden, idDetalle, idProducto, imagenProducto, nombreProducto, precioProducto,
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.textTitle}><Text style={styles.textA}>Precio de la compra: </Text>${precioTotal}</Text>
